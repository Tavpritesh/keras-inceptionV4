...
def get_processed_image(img_path):
   ...
   print("elapsed (sec): ", (after-before).seconds)
   print("elapsed (us): ", (after-before).microseconds)
...
if __name__ == "__main__":
   ...
   after = datetime.datetime.now()
   print("prediction elapsed (sec): ", (after-before).seconds)
   print("prediction elapsed (us): ", (after-before).microseconds)
